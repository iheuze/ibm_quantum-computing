// Create a parameterized CHSH circuit, run it using the Estimator primitive, analyse the results and demonstrate the violation of CHSH inequality
...
// backend = service.get_backend("ibmq_jakarta")
  // ibm_sherbrooke would be ideal but unfortunately i do not have access to it 
...
chsh_circuit_no_meas.draw("mpl")
  ...
  // number of phases to be assigned later
number_of_phases = 21
...
// Submit the Circuits to a Quantum Computer
